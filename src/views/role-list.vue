      ...
      <el-row :gutter="20" style="height: 100%">
        <el-col :xl="4" :lg="4" style="border-right: 1px solid #dcdfe6">
          ...
          <div style="margin-top: 16px">
            <div
              class="role-item"
              :class="{
                'role-item__dark': isDark,
                'role-item-active': !isDark && item.id === activeRoleId,
                'role-item-active__dark': isDark && item.id === activeRoleId,
              }"
                  ...
                  <el-dropdown-menu>
                    ...
                    <span v-action:role:edit>
                      <el-dropdown-item
                        @click="
                          handleDelete(
                            roleList.find((r) => r?.id === activeRoleId)
                          )
                        "
                      >
        ...
        <el-col :xl="20" :lg="20">
          <el-col :span="24">
            ...
            <el-col
              style="font-size: 8px; color: #777777; padding-left: 0px"
              :span="24"
            >
          ...
          <el-tabs
            v-model="activeName"
            class="demo-tabs"
            @tab-click="handleChangeRoleUserClient"
          >
            ...
            <el-tab-pane label="权限设置" name="second">
              ...
              <div v-for="(menu, index) in rolePermission" :key="index">
                <el-row>
                  <el-col :span="18" :style="{ fontWeight: 'bold' }">{{
                    menu.name
                  }}</el-col>
                ...
                <el-row
                  :gutter="16"
                  v-for="(checkbox, tab) in menu.children"
                  :key="tab"
                >
...
const onChangeCheckAll = (checked: boolean, permission: any) => {
  Object.assign(permission, {
    selected: checked
      ? permission.actionsOptions.map((obj: any) => obj.id)
      : [],
    indeterminate: false,
    checkedAll: checked,
  });
